...
class OnlinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create online' do
    assert_difference('Online.count') do
      post onlines_url,
           params: { online: { packPrice: @online.packPrice, packSize: @online.packSize, purchase_id: @online.purchase_id, receive: @online.receive } }, as: :json
    end
