...
class CellphonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cellphone" do
    assert_difference("Cellphone.count") do
      post cellphones_url, params: { cellphone: { kind: @cellphone.kind, number: @cellphone.number, user_id: @cellphone.user_id } }, as: :json
    end
  ...
  test "should update cellphone" do
    patch cellphone_url(@cellphone), params: { cellphone: { kind: @cellphone.kind, number: @cellphone.number, user_id: @cellphone.user_id } }, as: :json
    assert_response :success
  end
